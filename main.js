...
let keyboardContainerNumbers = document.querySelectorAll('.keyboard-container_numbers');
...
//el reser y el igual '=' no estan icluidos en el keyValues.
...
function calcAll(itemKey) {
    ...
    switch (itemKey) {
        ...
        case '.': 
            break;
        default: screenResult.value += itemKey;
            break;
    }
...
function updateTheme(num_theme) {
    ...
    switch (num_theme) {
        case 1: deleteTheme_1();
            break;

        case 2: deleteTheme_2();
            break;

        default: deleteTheme_3();
            break;
    }
}
